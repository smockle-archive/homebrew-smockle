class PhotoshopWebp < Formula
  ...
  def install
    ...
    if File.exist? "/Library/Application\ Support/Adobe/Plug-Ins/CC/File\ Formats/WebP.plugin"
      system "unlink", "/Library/Application\ Support/Adobe/Plug-Ins/CC/File\ Formats/WebP.plugin"
    end
    system "ln", "-s", lib/"WebP.plugin", "/Library/Application\ Support/Adobe/Plug-Ins/CC/File\ Formats"
  end
